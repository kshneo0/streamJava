...
//		boolean b = str.equals("world");
		...
		System.out.println(calculate(8,2,Ch05Sec01::multiply));
		
		Ch05Sec01 instance = new Ch05Sec01();		
		System.out.println(calculate(8,2,instance::subtract));
		
//		System.out.println(calculate(8,2,new Ch05Sec01()::subtract));
